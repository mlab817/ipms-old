...
class Project extends Model implements Searchable
{
    ...
    public static function boot()
    {
        ...
        static::deleting(function($model) {
            ...
            $model->regions()->delete();
            $model->funding_sources()->delete();
            $model->sdgs()->delete();
            $model->ten_point_agendas()->delete();
            $model->infrastructure_sectors()->delete();
            $model->infrastructure_subsectors()->delete();
            $model->prerequisites()->delete();
            $model->pdp_chapters()->delete();
            $model->operating_units()->delete();
            $model->pdp_indicators()->delete();
