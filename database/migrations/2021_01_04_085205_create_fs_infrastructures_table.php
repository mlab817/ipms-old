...
class CreateFsInfrastructuresTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('fs_infrastructures', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['project_id','fs_id'], 'pfsinfra_idx');
        });
    }
    ...
    {
        Schema::dropIfExists('fs_infrastructures');
    }
}
