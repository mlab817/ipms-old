...
class CreateOuInfrastructuresTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ou_infrastructures', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['project_id','ou_id'], 'pouinfra_idx');
        });
    }
    ...
    {
        Schema::dropIfExists('ou_infrastructures');
    }
}
