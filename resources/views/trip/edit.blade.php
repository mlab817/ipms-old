                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" value="1" name="has_row" @if(old('has_row') == 1 || $project->has_row == 1) checked @endif>
                                            Yes
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" value="0" name="has_row" @if(old('has_row') == 1 || $project->has_row == 1) checked @endif>
                                            No
                                        </label>
                                    </div>
