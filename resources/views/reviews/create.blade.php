                ...
                <div class="card card-info card-outline">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="pip" class="col-sm-3 required">Public Investment Program</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            <label for="pip_typology_id" class="col-sm-3 required">PIP Typology</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            <label for="cip" class="col-sm-3 required">Core Investment Program/Project</label>
                            <div class="col-sm-9">
                                <div class="form-check-inline">
                        ...
                        <div class="form-group row">
                            <label for="cip_type_id" class="col-sm-3 required">CIP Type</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            <label for="trip" class="col-sm-3 required">Three-Year Rolling Infrastructure Program/Project</label>
                            <div class="col-sm-9">
                                <div class="form-check-inline">
                        ...
                        <div class="form-group row">
                            <label for="ifp" class="col-sm-3 required">Infrastructure Flagship Project(IFP)</label>
                            <div class="col-sm-9">
                                <div class="form-check-inline">
                                    <label for="trip_1" class="form-check-label">
                        ...
                        <div class="form-group row">
                            <label for="trip" class="col-sm-3 required">Readiness Level</label>
                            <div class="col-sm-9">
