...
@section('content-header')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Add Project Status</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Add Project Status</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
...
@section('content')
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                <form action="{{ route('admin.project_statuses.store') }}" method="POST">
                    @csrf
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        ...
                        <a class="btn mr-2" href="{{ route('admin.project_statuses.index') }}">Back to List</a>
                    </div>
                </form>
            </div>
        </div>
