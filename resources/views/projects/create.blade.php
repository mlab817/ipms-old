...
@section('content')
    ...
    <form action="{{ route('projects.store') }}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        @endforeach
                        @error('bases')<span class="invalid-feedback">{{ $message }}</span>@enderror
                    </div>
                </div>
        ...
        <div class="card">
                <div class="card-header">
                    <strong>{{ __("Implementing Agencies") }}</strong>
                </div>
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            @foreach($ou_types as $type)
                                ...
                                @endforeach
                            @endforeach
                            @error('operating_units')<span class="invalid-feedback">{{ $message }}</span>@enderror
                        </div>
                    </div>
                </div>
        </div>
        ...
        <div class="card">
                <div class="card-header">
                    <strong>{{ __("Other PAP Information") }}</strong>
                </div>
                <div class="card-body">
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            @error('ict')<span class="invalid-feedback">{{ $message }}</span>@enderror
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            @error('covid')<span class="invalid-feedback">{{ $message }}</span>@enderror
                        </div>
                    </div>
        ...
        <div class="card">
                <div class="card-header">
                    <strong>{{ __("Spatial Coverage") }}</strong>
                </div>
                <div class="card-body">
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            @foreach($regions->sortBy('order') as $option)
                                ...
                                @endif
                            @endforeach
                            @error('regions')<span class="invalid-feedback">{{ $message }}</span>@enderror
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            @error('gad_id')<span class="invalid-feedback">{{ $message }}</span>@enderror
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
                <div class="card-header">
                    <strong>Regional Development Investment Program</strong>
                </div>
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            @error('rdip')<span class="invalid-feedback">{{ $message }}</span>@enderror
                        </div>
                    </div>
        ...
        <div class="card">
                <div class="card-header">
                    <strong>{{ __("Project Preparation Details") }}</strong>
                </div>
                <div class="card-body">
                    <div class="form-group row">
        ...
        <div class="card">
                <div class="card-header">
                    <strong>{{ __("Employment Generation") }}</strong>
                </div>
                <div class="card-body">
                    <div class="form-group row">
        ...
        <div class="card">
                <div class="card-header">
                    <strong>{{ __("Philippine Development Plan") }}</strong>
                </div>
                <div class="card-body">
                    <div class="form-group row">
                        <div class="col-sm-3">
        ...
        <div class="card">
                <div class="card-header">
                    <strong>{{ __("Philippine Development Results Matrices (PDP-RM) Indicators") }}</strong>
                </div>
        ...
        <div class="card">
                <div class="card-header">
                    <strong>{{ __("Sustainable Development Goals") }}</strong>
                </div>
                <div class="card-body">
                    <div class="row">
        ...
        <div class="card">
                <div class="card-header">
                    <strong>{{ __("Ten Point Agenda") }}</strong>
                </div>
                <div class="card-body">
                    <div class="row">
                        <p class="text-sm text-muted">Select all that applies</p>
        ...
        <div class="card">
                <div class="card-header">
                    <strong>{{ __("Financial Information") }}</strong>
                </div>
                <div class="card-body">
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            @error('tier_id')<span class="invalid-feedback">{{ $message }}</span>@enderror
                        </div>
                    </div>
                    <div class="form-group row">
        ...
        <div class="card">
                <div class="card-header">
                    <strong>{{ __("Status & Updates") }}</strong>
                </div>
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            @error('updates')<span class="invalid-feedback">{{ $message }}</span>@enderror
                        </div>
                    </div>
                    <div class="form-group row">
        ...
        <div class="card">
                <div class="card-header">
                    <strong>{{ __("Investment Required by Funding Source") }} </strong>
                </div>
        ...
        <div class="card">
                <div class="card-header">
                    <strong>{{ __("Investment Required by Region") }} </strong>
                </div>
                <div class="card-body p-0">
                    <table class="table table-responsive table-sm">
                        <thead>
        ...
        <div class="card">
                <div class="card-header">
                    <strong>{{ __("Financial Status") }}</strong>
                </div>
                <div class="card-body p-0">
                    <table class="table table-responsive table-sm">
                        <thead>
