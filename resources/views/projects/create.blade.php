            ...
            <form action="{{ route('projects.store') }}" method="POST">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-sm-9">
                                    <select type="text" class="form-control select2 @error('office_id') is-invalid @enderror" id="office_id" name="office_id">
                                        ...
                                        @foreach($offices as $option)
                                            <option value="{{ $option->id }}" @if(old('office_id') == $option->id) selected @endif>{{ $option->acronym }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control @error('project_status_id') is-invalid @enderror" id="project_status_id" name="project_status_id">
                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <label for="operating_units" class="col-form-label col-sm-3 required">Implementing Agencies (including own office) </label>
                                <div class="col-sm-9">
                                    ...
                                    @foreach($regions->sortBy('order') as $option)
                                        ...
                                        <div class="form-check">
                                            <label class="form-check-label @error('regions') text-danger @enderror">
                                                <input class="regions-checkboxes form-check-input" type="checkbox" name="regions[]" value="{{ $option->id }}" {{ in_array($option->id, old('regions') ?? []) ? 'checked' : '' }}>
                                                {{ $option->name }}
                                            </label>
                                        </div>
                                        @endif
                                ...
                                <div class="col-sm-9">
                                    <div class="form-check-inline">
                                        <label class="form-check-label" for="rdip_1">
                                            <input class="form-check-input" type="radio" id="rdip_1" name="rdip" value="1" @if(old('rdip') == 1) checked @endif>
                                            Yes
                                        </label>
                                    </div>
                                    <div class="form-check-inline">
                                        <label class="form-check-label" for="rdip_0">
                                            <input class="form-check-input" type="radio" id="rdip_0" name="rdip" value="0" @if(old('rdip') == 0) checked @endif>
                                            No
                                        </label>
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        @error('rdc_endorsed')<span class="error invalid-feedback">{{ $message }}</span>@enderror
                                    </div>
                                </div>
                                        ...
                                        @foreach($pi1->children as $pi2)
                                            <div class="ml-4">
                                                ...
                                                @foreach($pi2->children as $pi3)
                                                    <div class="ml-4">
                                                        <div class="form-check">
                                                            <label class="col form-check-label" for="pdp_suboutcome_{{$pi3->id}}">
                                                        ...
                                                        @foreach($pi3->children as $pi4)
                                                            <div class="ml-4">
                                                                <div class="form-check">
                                                                    <label class="col form-check-label" for="pdp_output_{{$pi4->id}}">
                                    ...
                                    @foreach($funding_sources as $option)
                                        <div class="form-check">
                                            <label class="form-check-label" for="fs_{{ $option->id }}">
                                                <input id="fs_{{ $option->id }}" type="checkbox" value="{{ $option->id }}" class="form-check-input" name="funding_sources[]">
                                                {{ $option->name }}
                                            </label>
                                        </div>
                                    @endforeach
                        ...
                        <div class="card-body">
                            <table class="table table-responsive table-sm">
                                ...
                                <tr>
                                    ...
                                    <td><input readonly type="text" class="nep money form-control text-right" name="nep[y2023]" value="{{ old("nep.y2023", 0) }}"></td>
                                ...
                                <tr>
                                    ...
                                    <td><input readonly type="text" class="allocation money form-control text-right" name="allocation[y2022]" value="{{ old("allocation.y2022", 0) }}"></td>
                                    <td><input readonly type="text" class="allocation money form-control text-right" name="allocation[y2023]" value="{{ old("allocation.y2023", 0) }}"></td>
                                ...
                                <tr>
                                    ...
                                    <td><input readonly type="text" class="disbursement money form-control text-right" name="disbursement[y2022]" value="{{ old("disbursement.y2022", 0) }}"></td>
                                    <td><input readonly type="text" class="disbursement money form-control text-right" name="disbursement[y2023]" value="{{ old("disbursement.y2023", 0) }}"></td>
