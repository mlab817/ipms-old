        ...
        <form action="{{ route('projects.pipols.store', $project) }}" method="POST" accept-charset="UTF-8">
            ...
            <div class="Box md Box--responsive">
                <div class="d-flex top-0 border-top-0 border-bottom p-2 flex-items-center flex-justify-between color-bg-primary rounded-top-2 is-stuck" style="position: sticky; z-index: 90; top: 0px !important;">
                    ...
                    <button class="float-right btn btn-primary" type="submit">Create</button>
                </div>
                ...
                <div class="Box-body">
                    <dl class="form-group my-3">
                        ...
                        <dd class="form-group-body">
                            <input type="text" class="form-control input-block" placeholder="PIPOL Title" id="project_title" name="project_title" value="{{ old('project_title') }}">
                    ...
                    <dl class="form-group my-3">
                        ...
                        <dd class="form-group-body">
                            <input type="text" class="form-control" placeholder="PIPOL Code" id="pipol_code" name="pipol_code" value="{{ old('pipol_code') }}">
                    ...
                    <dl class="form-group my-3">
                        ...
                        <dd class="form-group-body">
                            <input type="text" class="form-control" placeholder="PIPOL URL" id="pipol_url" name="pipol_url" value="{{ old('pipol_url') }}">
                        ...
                        <dd class="form-group-body">
                            <select type="text" class="form-select" id="submission_status" name="submission_status">
                                @foreach($submissionStatus as $key => $label)
                                    <option value="{{ $key }}" @if(old('submission_status') == $key) selected @endif>{{ $label }}</option>
                                @endforeach
                            </select>
                    ...
                    <dl class="form-group my-3">
                        ...
                        <dd class="form-group-body">
                            <textarea name="other_reason" id="other_reason" class="form-control" style="resize: none;">{{ old('other_reason') }}</textarea>
