        ...
        <script>
            document.addEventListener('alpine:init', () => {
                Alpine.data('fsInvestments', () => ({
                    items: @json(old('fs_investments', $project->fs_investments)),
                    funding_sources: @json($funding_sources),
                    get total() {
                    ...
                    fs(val) {
                        return this.funding_sources.filter(r => (parseInt(r.id) === parseInt(val)))[0].name
                    }
                }));
            });
        </script>
                ...
                <template x-for="(item, index) in items" :key="index">
                    <tr class="col-12 border-bottom" x-data="{
                        ...
                        <td class="col-1 p-1">
                            ...
                            <span x-text="fs(item.fs_id)"></span>
                        </td>
                        <td class="col-1 p-1">
                            <input type="number" class="form-control text-right border-0 pr-1 width-full" x-bind:name="`fs_investments[${index}][y2016]`" x-model="item.y2016">
                        </td>
                        <td class="col-1 p-1">
                            <input type="number" class="form-control text-right border-0 pr-1 width-full" x-bind:name="`fs_investments[${index}][y2017]`" x-model="item.y2017">
                        </td>
                        <td class="col-1 p-1">
                            <input type="number" class="form-control text-right border-0 pr-1 width-full" x-bind:name="`fs_investments[${index}][y2018]`" x-model="item.y2018">
                        </td>
                        <td class="col-1 p-1">
                            <input type="number" class="form-control text-right border-0 pr-1 width-full" x-bind:name="`fs_investments[${index}][y2019]`" x-model="item.y2019">
                        </td>
                        <td class="col-1 p-1">
                            <input type="number" class="form-control text-right border-0 pr-1 width-full" x-bind:name="`fs_investments[${index}][y2020]`" x-model="item.y2020">
                        </td>
                        <td class="col-1 p-1">
                            <input type="number" class="form-control text-right border-0 pr-1 width-full" x-bind:name="`fs_investments[${index}][y2021]`" x-model="item.y2021">
                        </td>
                        <td class="col-1 p-1">
                            <input type="number" class="form-control text-right border-0 pr-1 width-full" x-bind:name="`fs_investments[${index}][y2022]`" x-model="item.y2022">
                        </td>
                        <td class="col-1 p-1">
                            <input type="number" class="form-control text-right border-0 pr-1 width-full" x-bind:name="`fs_investments[${index}][y2023]`" x-model="item.y2023">
                        </td>
