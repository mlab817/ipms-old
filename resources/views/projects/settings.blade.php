                                ...
                                <details-dialog class="Box Box--overlay d-flex flex-column anim-fade-in fast">
                                    ...
                                    <div class="Box-body" x-data="{
                                        ...
                                        <form action="{{ route('projects.destroy', $project) }}" method="POST">
                                            ...
                                            @method('DELETE')
                                            <p>
                                                This action <strong>cannot</strong> be undone. This will permanently delete the <strong>{{ $project->title }}</strong>'s profile, trip, review, pipol, attachments, history, and issues.
                                            </p>
                                            <p>
                                            ...
                                            <p>
                                                Please type <strong>{{ $project->uuid }}</strong> to confirm.
                                            </p>
                                            <p>
                                                <input type="text" class="form-control width-full" name="uuid" x-model="uuid">
                                            </p>
                                            <button type="submit" class="btn btn-danger btn-block" x-bind:disabled="uuid !== '{{ $project->uuid }}' || !reason">
