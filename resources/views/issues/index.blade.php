            ...
            <div class="js-check-all-container" data-pjax="">
                ...
                <div class="d-flex flex-justify-between mb-md-3 flex-column-reverse flex-md-row flex-items-end">
                    <div class="d-flex flex-justify-start flex-auto width-full my-4 my-md-0" role="search">
                                ...
                                <div class="SelectMenu-modal">
                                    ...
                                    <div class="SelectMenu-list">
                                        <a class="SelectMenu-item" role="menuitemradio" aria-checked="false"
                                           href="/mlab817/pips/issues?q=is%3Aopen"
                                           data-ga-click="Issues, Search filter, Open issues and pull requests">
                                        ...
                                        <a class="SelectMenu-item" role="menuitemradio" aria-checked="false"
                                           href="/mlab817/pips/issues?q=is%3Aopen+is%3Aissue+author%3A%40me"
                                           data-ga-click="Issues, Search filter, Your issues">
                                            <svg aria-hidden="true" viewBox="0 0 16 16" version="1.1"
                                                 data-view-component="true" height="16" width="16"
                                                 class="octicon octicon-check SelectMenu-icon SelectMenu-icon--check">
                                                <path fill-rule="evenodd"
                                        ...
                                        <a class="SelectMenu-item" role="menuitemradio" aria-checked="false"
                                           href="/mlab817/pips/issues?q=is%3Aopen+is%3Apr+author%3A%40me"
                                           data-ga-click="Issues, Search filter, Your pull requests">
                                            <svg aria-hidden="true" viewBox="0 0 16 16" version="1.1"
                                                 data-view-component="true" height="16" width="16"
                                                 class="octicon octicon-check SelectMenu-icon SelectMenu-icon--check">
                                                <path fill-rule="evenodd"
                                        ...
                                        <a class="SelectMenu-item" role="menuitemradio" aria-checked="false"
                                           href="/mlab817/pips/issues?q=is%3Aopen+assignee%3A%40me"
                                           data-ga-click="Issues, Search filter, Everything assigned to you">
                                            <svg aria-hidden="true" viewBox="0 0 16 16" version="1.1"
                                                 data-view-component="true" height="16" width="16"
                                                 class="octicon octicon-check SelectMenu-icon SelectMenu-icon--check">
                                                <path fill-rule="evenodd"
                                        ...
                                        <a class="SelectMenu-item" role="menuitemradio" aria-checked="false"
                                           href="/mlab817/pips/issues?q=is%3Aopen+mentions%3A%40me"
                                           data-ga-click="Issues, Search filter, Everything mentioning you">
                                            <svg aria-hidden="true" viewBox="0 0 16 16" version="1.1"
                                                 data-view-component="true" height="16" width="16"
                                                 class="octicon octicon-check SelectMenu-icon SelectMenu-icon--check">
                                                <path fill-rule="evenodd"
                                        ...
                                        <a class="SelectMenu-item" role="menuitemradio"
                                           href="https://docs.github.com/articles/searching-issues" target="_blank">
                                            <svg aria-hidden="true" viewBox="0 0 16 16" version="1.1"
                                                 data-view-component="true" height="16" width="16"
                                                 class="octicon octicon-link-external mr-2">
                                                <path fill-rule="evenodd"
                        ...
                        <!-- '"` --><!-- </textarea></xmp> -->
                        <form class="subnav-search width-full " data-pjax="true" role="search" aria-label="Issues"
                              action="/mlab817/pips/issues" accept-charset="UTF-8" method="get">
                        ...
                        <div class="ml-2 pl-2 d-none d-md-flex">
                            ...
                            <nav class="subnav-links float-left d-flex no-wrap" aria-label="Issue">
                                <a selected_link="repo_issues" class="js-selected-navigation-item subnav-item"
                                   data-selected-links="repo_labels /mlab817/pips/labels" href="/mlab817/pips/labels">
                                    <svg aria-hidden="true" viewBox="0 0 16 16" version="1.1" data-view-component="true"
                                    ...
                                    Labels
                                    <span title="9" data-view-component="true"
                                          class="Counter d-none d-md-inline">9</span>
                                </a> <a selected_link="repo_issues" class="js-selected-navigation-item subnav-item"
                                        data-selected-links="repo_milestones /mlab817/pips/milestones"
                                        href="/mlab817/pips/milestones">
                                    <svg aria-hidden="true" viewBox="0 0 16 16" version="1.1" data-view-component="true"
                                         height="16" width="16" class="octicon octicon-milestone">
                                        <path fill-rule="evenodd"
                                    ...
                                    Milestones
                                    <span title="0" data-view-component="true"
                                          class="Counter d-none d-md-inline">0</span>
                                </a></nav>
  ...
  <a selected_link="repo_issues" class="js-selected-navigation-item subnav-item"
    ...
    Labels
      <span title="9" data-view-component="true" class="Counter d-none d-md-inline">9</span>
         ...
         data-selected-links="repo_milestones /mlab817/pips/milestones" href="/mlab817/pips/milestones">
    <svg aria-hidden="true" viewBox="0 0 16 16" version="1.1" data-view-component="true" height="16" width="16"
      ...
      <span title="0" data-view-component="true" class="Counter d-none d-md-inline">0</span>
                ...
                <div class="d-block d-lg-none no-wrap">
                    ...
                    <div class="table-list-header-toggle states flex-auto pl-0">
                        <a href="/mlab817/pips/issues?q=is%3Aopen+is%3Aissue" class="btn-link selected"
                        ...
                        <div class="table-list-filters flex-auto d-flex min-width-0">
                            ...
                            <div
                                ...
                                <details class="details-reset details-overlay d-inline-block position-relative px-3"
                                    ...
                                    <summary class="btn-link" title="Author" data-hotkey="u" aria-haspopup="menu"
                                             data-ga-click="Issues, Table filter, Author" role="button">
                                        Author
                                        <span class="dropdown-caret hide-sm"></span>
                                    </summary>
                                    <details-menu class="SelectMenu SelectMenu--hasFilter right-lg-0" role="menu"
                                                  src="/mlab817/pips/issues/show_menu_content?partial=issues%2Ffilters%2Fauthors_content&amp;q=is%3Aissue+is%3Aopen"
                                                  preload="">
                                        <div class="SelectMenu-modal">
                                            ...
                                            <div class="SelectMenu-list select-menu-list" data-filter="author">
                                                <div data-filterable-for="author-filter-field"
                                                    ...
                                                    <a class="SelectMenu-item" aria-checked="false" role="menuitemradio"
                                                       href="/mlab817/pips/issues?q=is%3Aissue+is%3Aopen+author%3Amlab817">
                                                        <svg aria-hidden="true" viewBox="0 0 16 16" version="1.1"
                                                             data-view-component="true" height="16" width="16"
                                                             class="octicon octicon-check SelectMenu-icon SelectMenu-icon--check">
                                                            <path fill-rule="evenodd"
                                                        ...
                                                        <img class="avatar flex-shrink-0 mr-2 avatar-user"
                                                             src="https://avatars.githubusercontent.com/u/29625844?s=40&amp;v=4"
                                                             width="20" height="20" alt="@mlab817">
                                                        <strong class="mr-2">mlab817</strong>
                                                        <span
                                                            class="color-text-tertiary css-truncate css-truncate-overflow">Mark Lester Bolotaolo</span>
                                                    </a>
                                                    ...
                                                    <include-fragment class="SelectMenu-loading">
                                                        <svg
                                                            ...
                                                            width="32" height="32" class="mx-auto d-block anim-rotate">
                                                ...
                                                <!-- '"` --><!-- </textarea></xmp> -->
                                                <form class="select-menu-new-item-form js-new-item-form"
                                                      action="/mlab817/pips/issues?q=is%3Aopen+is%3Aissue"
                                                      accept-charset="UTF-8" method="get">
                                                    <input type="hidden" name="q" value="is:issue is:open">
                                                    <button class="SelectMenu-item d-block js-new-item-value"
                                                            type="submit" name="author" role="menuitem">
                                                        <div class="text-bold f5">author:<span
                                                                class="js-new-item-name"></span></div>
                                ...
                                <details class="details-reset details-overlay d-inline-block position-relative px-3"
                                         id="label-select-menu">
                                    <summary class="btn-link" title="Label" data-hotkey="l" aria-haspopup="menu"
                                             data-ga-click="Issues, Table filter, Label" role="button">
                                        Label
                                        <span class="dropdown-caret hide-sm"></span>
                                    </summary>
                                    <details-menu class="SelectMenu SelectMenu--hasFilter right-lg-0" role="menu"
                                                  src="/mlab817/pips/issues/show_menu_content?partial=issues%2Ffilters%2Flabels_content&amp;q=is%3Aissue+is%3Aopen"
                                                  preload="">
                                        <div class="SelectMenu-modal">
                                            <header class="SelectMenu-header">
                                                <span class="SelectMenu-title">Filter by label</span>
                                                <button class="SelectMenu-closeButton" type="button"
                                                        data-toggle-for="label-select-menu">
                                                    <svg aria-label="Close menu" role="img" viewBox="0 0 16 16"
                                                         version="1.1" data-view-component="true" height="16" width="16"
                                                         class="octicon octicon-x">
                                                        <path fill-rule="evenodd"
                                            ...
                                            <div class="SelectMenu-filter">
                                                <input type="text" id="label-filter-field"
                                                       class="SelectMenu-input form-control js-filterable-field"
                                                       placeholder="Filter labels" aria-label="Filter labels"
                                            ...
                                            <footer class="SelectMenu-footer">
                                                <span>Use <kbd
                                                        class="js-modifier-key">alt</kbd> + <kbd>click/return</kbd> to exclude labels.</span>
                                            </footer>
                                        </div>
                                    </details-menu>
                                </details>
...
<details class="details-reset details-overlay d-inline-block position-relative px-3" id="project-select-menu">
  <summary class="btn-link" data-hotkey="p" aria-haspopup="menu" data-ga-click="Issues, Table filter, Projects"
           role="button">
    Projects
    <span class="dropdown-caret hide-sm"></span>
  </summary>
  <details-menu class="SelectMenu SelectMenu--hasFilter right-lg-0" role="menu"
                src="/mlab817/pips/issues/show_menu_content?partial=issues%2Ffilters%2Fprojects_content&amp;pulls_only=false&amp;q=is%3Aissue+is%3Aopen"
                preload="">
    <div class="SelectMenu-modal">
      <header class="SelectMenu-header">
    ...
    <path fill-rule="evenodd"
      ...
      <include-fragment class="SelectMenu-loading">
        <svg style="box-sizing: content-box; color: var(--color-icon-primary);" viewBox="0 0 16 16" fill="none"
             data-view-component="true" width="32" height="32" class="mx-auto d-block anim-rotate">
...
<details class="details-reset details-overlay d-inline-block position-relative px-3" id="milestones-select-menu">
  <summary class="btn-link" data-hotkey="m" aria-haspopup="menu" data-ga-click="Issues, Table filter, Milestones"
           role="button">
    Milestones
    <span class="dropdown-caret hide-sm"></span>
  </summary>
  <details-menu class="SelectMenu SelectMenu--hasFilter right-lg-0" role="menu"
                src="/mlab817/pips/issues/show_menu_content?partial=issues%2Ffilters%2Fmilestones_content&amp;q=is%3Aissue+is%3Aopen"
                preload="">
    <div class="SelectMenu-modal">
      <header class="SelectMenu-header">
    ...
    <path fill-rule="evenodd"
      ...
      <div class="SelectMenu-filter">
        <input class="SelectMenu-input form-control js-filterable-field" id="milestones-filter-field" type="text"
               placeholder="Filter milestones" aria-label="Filter milestones" autocomplete="off" autofocus="">
      </div>
      <include-fragment class="SelectMenu-loading">
        <svg style="box-sizing: content-box; color: var(--color-icon-primary);" viewBox="0 0 16 16" fill="none"
             data-view-component="true" width="32" height="32" class="mx-auto d-block anim-rotate">
  ...
  <path d="M15 8a7.002 7.002 0 00-7-7" stroke="currentColor" stroke-width="2" stroke-linecap="round"
        vector-effect="non-scaling-stroke"></path>
                                ...
                                <details class="details-reset details-overlay d-inline-block position-relative px-3"
                                    ...
                                    <summary class="btn-link" title="Assignees" data-hotkey="a" aria-haspopup="menu"
                                             data-ga-click="Issues, Table filter, Assignee" role="button">
                                        Assignee
                                        <span class="dropdown-caret hide-sm"></span>
                                    </summary>
                                    <details-menu class="SelectMenu SelectMenu--hasFilter right-md-0" role="menu"
                                                  src="/mlab817/pips/issues/show_menu_content?partial=issues%2Ffilters%2Fassigns_content&amp;q=is%3Aissue+is%3Aopen"
                                                  preload="">
                                        <div class="SelectMenu-modal">
                                            <header class="SelectMenu-header">
                                                <span class="SelectMenu-title">Filter by who’s assigned</span>
                                                <button class="SelectMenu-closeButton" type="button"
                                                        data-toggle-for="assignees-select-menu">
                                                    <svg aria-label="Close menu" role="img" viewBox="0 0 16 16"
                                                         version="1.1" data-view-component="true" height="16" width="16"
                                                         class="octicon octicon-x">
                                                        <path fill-rule="evenodd"
                                            ...
                                            <div class="SelectMenu-filter">
                                                <input type="text" id="assigns-filter-field"
                                                       class="SelectMenu-input form-control js-filterable-field"
                                        ...
                                        <div class="SelectMenu-modal">
                                            ...
                                            <div class="SelectMenu-list">
                                                <a class="SelectMenu-item" aria-checked="true" role="menuitemradio"
                                                   href="/mlab817/pips/issues?q=is%3Aopen+is%3Aissue">
                                                    <svg aria-hidden="true" viewBox="0 0 16 16" version="1.1"
                                                         data-view-component="true" height="16" width="16"
                                                         class="octicon octicon-check SelectMenu-icon SelectMenu-icon--check">
                                                        <path fill-rule="evenodd"
                                                ...
                                                <a class="SelectMenu-item" aria-checked="false" role="menuitemradio"
                                                   href="/mlab817/pips/issues?q=is%3Aissue+is%3Aopen+sort%3Acreated-asc">
                                                    <svg aria-hidden="true" viewBox="0 0 16 16" version="1.1"
                                                         data-view-component="true" height="16" width="16"
                                                         class="octicon octicon-check SelectMenu-icon SelectMenu-icon--check">
                                                        <path fill-rule="evenodd"
                                                ...
                                                <a class="SelectMenu-item" aria-checked="false" role="menuitemradio"
                                                   href="/mlab817/pips/issues?q=is%3Aissue+is%3Aopen+sort%3Acomments-desc">
                                                    <svg aria-hidden="true" viewBox="0 0 16 16" version="1.1"
                                                         data-view-component="true" height="16" width="16"
                                                         class="octicon octicon-check SelectMenu-icon SelectMenu-icon--check">
                                                        <path fill-rule="evenodd"
                                                ...
                                                <a class="SelectMenu-item" aria-checked="false" role="menuitemradio"
                                                   href="/mlab817/pips/issues?q=is%3Aissue+is%3Aopen+sort%3Acomments-asc">
                                                    <svg aria-hidden="true" viewBox="0 0 16 16" version="1.1"
                                                         data-view-component="true" height="16" width="16"
                                                         class="octicon octicon-check SelectMenu-icon SelectMenu-icon--check">
                                                        <path fill-rule="evenodd"
                                                ...
                                                <a class="SelectMenu-item" aria-checked="false" role="menuitemradio"
                                                   href="/mlab817/pips/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc">
                                                    <svg aria-hidden="true" viewBox="0 0 16 16" version="1.1"
                                                         data-view-component="true" height="16" width="16"
                                                         class="octicon octicon-check SelectMenu-icon SelectMenu-icon--check">
                                                        <path fill-rule="evenodd"
                                                ...
                                                <a class="SelectMenu-item" aria-checked="false" role="menuitemradio"
                                                   href="/mlab817/pips/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-asc">
                                                    <svg aria-hidden="true" viewBox="0 0 16 16" version="1.1"
                                                         data-view-component="true" height="16" width="16"
                                                         class="octicon octicon-check SelectMenu-icon SelectMenu-icon--check">
                                                        <path fill-rule="evenodd"
                                                ...
                                                <div class="clearfix ws-normal p-3 p-sm-2">
                                                    <a class="reaction-sort-item width-auto m-0 px-3 py-2"
                                                       aria-checked="false" role="menuitemradio"
                                                       href="/mlab817/pips/issues?q=is%3Aissue+is%3Aopen+sort%3Areactions-%2B1-desc">
                                                        <g-emoji alias="+1"
                                                                 fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f44d.png"
                                                                 class="emoji m-0 v-align-baseline"><img class="emoji"
                                                                                                         alt="+1"
                                                                                                         height="20"
                                                                                                         width="20"
                                                    ...
                                                    <a class="reaction-sort-item width-auto m-0 px-3 py-2"
                                                       aria-checked="false" role="menuitemradio"
                                                       href="/mlab817/pips/issues?q=is%3Aissue+is%3Aopen+sort%3Areactions--1-desc">
                                                        <g-emoji alias="-1"
                                                    ...
                                                    <a class="reaction-sort-item width-auto m-0 px-3 py-2"
                                                       aria-checked="false" role="menuitemradio"
                                                       href="/mlab817/pips/issues?q=is%3Aissue+is%3Aopen+sort%3Areactions-smile-desc">
                                                        <g-emoji alias="smile"
                                                    ...
                                                    <a class="reaction-sort-item width-auto m-0 px-3 py-2"
                                                       aria-checked="false" role="menuitemradio"
                                                       href="/mlab817/pips/issues?q=is%3Aissue+is%3Aopen+sort%3Areactions-tada-desc">
                                                        <g-emoji alias="tada"
                                                    ...
                                                    <a class="reaction-sort-item width-auto m-0 px-3 py-2"
                                                       aria-checked="false" role="menuitemradio"
                                                       href="/mlab817/pips/issues?q=is%3Aissue+is%3Aopen+sort%3Areactions-thinking_face-desc">
                                                    ...
                                                    <a class="reaction-sort-item width-auto m-0 px-3 py-2"
                                                       aria-checked="false" role="menuitemradio"
                                                       href="/mlab817/pips/issues?q=is%3Aissue+is%3Aopen+sort%3Areactions-heart-desc">
                                                        <g-emoji alias="heart"
                                                    ...
                                                    <a class="reaction-sort-item width-auto m-0 px-3 py-2"
                                                       aria-checked="false" role="menuitemradio"
                                                       href="/mlab817/pips/issues?q=is%3Aissue+is%3Aopen+sort%3Areactions-rocket-desc">
                                                    ...
                                                    <a class="reaction-sort-item width-auto m-0 px-3 py-2"
                                                       aria-checked="false" role="menuitemradio"
                                                       href="/mlab817/pips/issues?q=is%3Aissue+is%3Aopen+sort%3Areactions-eyes-desc">
                                                        <g-emoji alias="eyes"
      ...
      <span class="color-text-secondary">
        ...
        <span class="js-issue-triage-spinner" hidden="">
          <svg aria-label="Saving" style="box-sizing: content-box; color: var(--color-icon-primary);"
               viewBox="0 0 16 16" fill="none" data-view-component="true" width="16" height="16"
  ...
  <path d="M15 8a7.002 7.002 0 00-7-7" stroke="currentColor" stroke-width="2" stroke-linecap="round"
        vector-effect="non-scaling-stroke"></path>
                                ...
                                <span class="color-text-danger f6 js-issue-triage-error"
                                      hidden="">Something went wrong.</span>
                                <details
                                    class="details-reset details-overlay select-menu d-inline-block js-issue-triage-menu"
                                    data-url="/mlab817/pips/issues/show_menu_content?partial=issues%2Ftriage%2Factions_content">
                                    <summary class="btn-link select-menu-button" aria-haspopup="menu" role="button">
                                        Mark as
                                    </summary>
                                    <details-menu class="SelectMenu-modal position-absolute right-0"
                                                  style="z-index: 99;" role="menu">
                                        <!-- '"` --><!-- </textarea></xmp> -->
                                        <form action="/mlab817/pips/issues/triage" accept-charset="UTF-8" method="post">
                                            <input type="hidden" name="_method" value="put"><input type="hidden"
                                                                                                   name="authenticity_token"
                                                                                                   value="C3U9riqFiQLAFHgZZADDd/GMSaO7HDCfCdxKvvgolOBswhV9T8ynCdUETGLMXUisG7zLdXgATokpX/dUHx7gXg==">
                                            <div class="SelectMenu-header">
                                ...
                                <details
                                    ...
                                    data-url="/mlab817/pips/issues/show_menu_content?partial=issues%2Ftriage%2Flabels_content">
                                    <summary class="btn-link select-menu-button" aria-haspopup="menu" role="button">
                                        Label
                                    </summary>
                                    <details-menu class="SelectMenu-modal position-absolute right-0"
                                        ...
                                        <form action="/mlab817/pips/issues/triage" accept-charset="UTF-8" method="post">
                                            <input type="hidden" name="_method" value="put"><input type="hidden"
                                                                                                   name="authenticity_token"
                                                                                                   value="PWFIz4nW1KRGBCFzr9IUzUFg7Q67QXginHwRyuCJg1Za1mAc7J/6r1MUFQgHj58Wq1Bv2HhdBjS8/6wgB7/36A==">
                                            <div class="SelectMenu-header">
                                ...
                                <details
                                    class="details-reset details-overlay select-menu d-inline-block js-issue-triage-menu"
                                    data-url="/mlab817/pips/issues/show_menu_content?partial=issues%2Ftriage%2Fmilestones_content">
                                    <summary class="btn-link select-menu-button" aria-haspopup="menu" role="button">
                                        Milestone
                                    </summary>
                                    <details-menu class="SelectMenu-modal position-absolute right-0"
                                        ...
                                        <form action="/mlab817/pips/issues/triage" accept-charset="UTF-8" method="post">
                                            <input type="hidden" name="_method" value="put"><input type="hidden"
                                                                                                   name="authenticity_token"
                                                                                                   value="SpQx+VWdtV9ZpuB7ZHHKdI7onGWHt4DaXMKKrktIqhotIxkqMNSbVEy21ADMLEGvZNges0Sr/sx8QTdErH7epA==">
                                            <div class="SelectMenu-header">
                                            ...
                                            <div class="select-menu-filters">
                                                <div class="SelectMenu-filter">
                                                    <input type="text" id="triage-milestones-filter-field"
                                                           ...
                                                           aria-label="Filter milestones" autocomplete="off"
                                                           autofocus="">
                                                </div>
                                            </div>
                                ...
                                <details
                                    class="details-reset details-overlay select-menu d-inline-block js-issue-triage-menu"
                                    data-url="/mlab817/pips/issues/show_menu_content?partial=issues%2Ftriage%2Fassigns_content">
                                    <summary class="btn-link select-menu-button" aria-haspopup="menu" role="button">
                                        Assign
                                    </summary>
                                    <details-menu class="SelectMenu-modal position-absolute right-0"
                                        ...
                                        <form action="/mlab817/pips/issues/triage" accept-charset="UTF-8" method="post">
                                            <input type="hidden" name="_method" value="put"><input type="hidden"
                                                                                                   name="authenticity_token"
                                                                                                   value="KdN/KWTrLFdcF53q4Lajxhum07J2NaBJnhSn0CFvPC9OZFf6AaICXEkHqZFI6ygd8ZZRZLUp3l++lxo6xllIkQ==">
                                            <div class="SelectMenu-header">
                                ...
                                <template class="js-triage-loader-template">
                                    <include-fragment class="SelectMenu-loading">
                                        <div data-hide-on-error="">
                                            <svg style="box-sizing: content-box; color: var(--color-icon-primary);"
                                                 viewBox="0 0 16 16" fill="none" data-view-component="true" width="32"
                                                 height="32" class="mx-auto d-block anim-rotate">
                                        ...
                                        <div class="text-center p-3" data-show-on-error="" hidden="">
                                            ...
                                            <button data-retry-button="" type="button" data-view-component="true"
                                                    class="btn-sm btn">
                            ...
                            <div id="issue_5"
                                ...
                                <div class="d-flex Box-row--drag-hide position-relative">
                                    ...
                                    <label class="flex-shrink-0 py-2 pl-3  d-none d-md-block">
                                        <input type="checkbox" data-check-all-item="" class="js-issues-list-check"
                                               name="issues[]" value="5" aria-labelledby="issue_5_link"
                                               autocomplete="off">
                                    </label>
