                        ...
                        <div class="gh-header-show ">
                            <div class="d-flex flex-column flex-md-row">
                                <div
                                    ...
                                    <a href="{{ route('issues.edit', $issue) }}" role="button"
                                       class="btn btn-sm js-details-target d-inline-block float-none m-0 mr-md-0"
                                       aria-label="Edit Issue">Edit</a>
                                    ...
                                    <div class="Box Box--blue">
                                        <div class="Box-header Box-header--blue clearfix p-2 d-block d-flex">
                                            <h3 class="f5 text-normal flex-auto">
                                                <a class="d-inline-block d-md-none" href="/mlab817"><img class="avatar rounded-1 avatar-user" height="20" width="20" alt="@mlab817" src="https://avatars.githubusercontent.com/u/29625844?s=60&amp;u=d91e78d8a141a611c4a71d49987e46541f951b00&amp;v=4"></a>
                                            ...
                                            <details class="details-overlay details-reset position-relative d-inline-block float-right">
                                                ...
                                                <details-menu class="dropdown-menu dropdown-menu-sw show-more-popover color-text-primary anim-scale-in" style="width:185px" src="/mlab817/ipms-v2/issues/24/actions_menu?href=%23issue-930687142&amp;gid=MDU6SXNzdWU5MzA2ODcxNDI%3D" preload="" role="menu">
