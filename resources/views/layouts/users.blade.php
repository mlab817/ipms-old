        ...
        <nav
            ...
            <div class="width-full d-flex position-relative container-lg">
                <ul class="list-style-none UnderlineNav-body width-full p-responsive overflow-hidden">
                    ...
                    <li class="d-flex">
                        <a class="UnderlineNav-item @if($route == 'users.base-projects.index') selected @endif" href="{{ route('users.base-projects.index', $user) }}">
                            ...
                            Projects
                            <span title="{{ $user->owned_base_projects->count() }}" hidden="hidden" class="Counter">{{ $user->owned_base_projects->count() }}</span>
                        </a>
                    </li>
                    ...
                    <li class="d-flex">
                        <a class="UnderlineNav-item @if($route == 'users.projects') selected @endif" href="{{ route('users.projects', $user) }}">
                            ...
                            Follow
                            <span title="" hidden="hidden" class="Counter">{{ $user->projects->count() }}</span>
                        </a>
                    </li>
