                ...
                <details-menu class="SelectMenu" role="menu">
                    <div class="SelectMenu-modal rounded-3 mt-1" style="max-height:340px;">
                        <div class="SelectMenu-list SelectMenu-list--borderless p-2" style="overscroll-behavior: contain;">
                            <a role="menuitem" class="filter-item py-1 " style="padding-left: 24px;" data-action="click:readme-toc#blur" data-targets="readme-toc.entries" data-hydro-click="{&quot;event_type&quot;:&quot;repository_toc_menu.click&quot;,&quot;payload&quot;:{&quot;target&quot;:&quot;entry&quot;,&quot;repository_id&quot;:380256079,&quot;originating_url&quot;:&quot;https://github.com/mlab817/pips&quot;,&quot;user_id&quot;:29625844}}" data-hydro-click-hmac="4fe7439e75f410ed65a053a3b84a3848e32b261f272f07c3d15aeece6e52ae61" href="#about-ipms" aria-current="page">About IPMS</a>
                            <a role="menuitem" class="filter-item py-1 " style="padding-left: 24px;" data-action="click:readme-toc#blur" data-targets="readme-toc.entries" data-hydro-click="{&quot;event_type&quot;:&quot;repository_toc_menu.click&quot;,&quot;payload&quot;:{&quot;target&quot;:&quot;entry&quot;,&quot;repository_id&quot;:380256079,&quot;originating_url&quot;:&quot;https://github.com/mlab817/pips&quot;,&quot;user_id&quot;:29625844}}" data-hydro-click-hmac="4fe7439e75f410ed65a053a3b84a3848e32b261f272f07c3d15aeece6e52ae61" href="#deployment">Deployment</a>
                            <a role="menuitem" class="filter-item py-1 " style="padding-left: 24px;" data-action="click:readme-toc#blur" data-targets="readme-toc.entries" data-hydro-click="{&quot;event_type&quot;:&quot;repository_toc_menu.click&quot;,&quot;payload&quot;:{&quot;target&quot;:&quot;entry&quot;,&quot;repository_id&quot;:380256079,&quot;originating_url&quot;:&quot;https://github.com/mlab817/pips&quot;,&quot;user_id&quot;:29625844}}" data-hydro-click-hmac="4fe7439e75f410ed65a053a3b84a3848e32b261f272f07c3d15aeece6e52ae61" href="#bug-report">Bug Report</a>
                            <a role="menuitem" class="filter-item py-1 " style="padding-left: 24px;" data-action="click:readme-toc#blur" data-targets="readme-toc.entries" data-hydro-click="{&quot;event_type&quot;:&quot;repository_toc_menu.click&quot;,&quot;payload&quot;:{&quot;target&quot;:&quot;entry&quot;,&quot;repository_id&quot;:380256079,&quot;originating_url&quot;:&quot;https://github.com/mlab817/pips&quot;,&quot;user_id&quot;:29625844}}" data-hydro-click-hmac="4fe7439e75f410ed65a053a3b84a3848e32b261f272f07c3d15aeece6e52ae61" href="#security-vulnerabilities">Security Vulnerabilities</a>
                            <a role="menuitem" class="filter-item py-1 " style="padding-left: 24px;" data-action="click:readme-toc#blur" data-targets="readme-toc.entries" data-hydro-click="{&quot;event_type&quot;:&quot;repository_toc_menu.click&quot;,&quot;payload&quot;:{&quot;target&quot;:&quot;entry&quot;,&quot;repository_id&quot;:380256079,&quot;originating_url&quot;:&quot;https://github.com/mlab817/pips&quot;,&quot;user_id&quot;:29625844}}" data-hydro-click-hmac="4fe7439e75f410ed65a053a3b84a3848e32b261f272f07c3d15aeece6e52ae61" href="#license">License</a>
                        </div>
                    </div>
                </details-menu>
            </details>
                ...
                <dd>
                    @foreach($pap_types as $pap_type)
                        <div class="form-checkbox ">
                            <label>
                                <input class="form-checkbox-details-trigger" type="radio" id="pap_type_{{$pap_type->id}}" name="pap_type_id" value="{{ $pap_type->id }}" @if(old('pap_type_id', $project->pap_type_id) == $pap_type->id) checked @endif>
                                {{ $pap_type->name }}
                                <p class="note">
                                ...
                                @if($pap_type->id ==1)
                                    <span class="form-checkbox-details text-normal d-block">
                                        ...
                                        <select class="form-select" name="regular_program" id="regular_program" @if($project->pap_type_id == 2) disabled @endif>
                                            <option value="0" @if($project->regular_program == 0) selected @endif>No</option>
                                            <option value="1" @if($project->regular_program == 1) selected @endif>Yes</option>
                                        </select>
                                    </span>
                                @endif
                            </label>
                        ...
                        <script>
                            // toggle visibility on change
                            document.getElementById('pap_type_{{$pap_type->id}}').addEventListener('click', function () {
                                if ({{ old('pap_type_id', $project->pap_type_id) }} !== Number({{$pap_type->id}})) {
                                    document.getElementById('submit-pap-type').classList.remove('d-none');
                                } else {
                                    document.getElementById('submit-pap-type').classList.add('d-none');
                                }
                                // if select pap_type is project, hide regular program
                                if ({{$pap_type->id}} === 2) {
                                    document.getElementById('regular_program').disabled = true;
                                    document.getElementById('regular_program').value = {{$project->regular_program}};
                                }
                                // if select pap_type is project, show regular program
                                if ({{$pap_type->id}} === 1) {
                                    document.getElementById('regular_program').disabled = false;
                                    document.getElementById('regular_program').value = {{$project->regular_program}};
                                }
                            });
                            document.getElementById('regular_program').addEventListener('change', function () {
                                if ({{ old('regular_program', $project->regular_program) }} !== document.getElementById('regular_program').value) {
                                    document.getElementById('submit-pap-type').classList.remove('d-none');
                                } else {
                                    document.getElementById('submit-pap-type').classList.add('d-none');
                                }
                    ...
                    @endforeach
                    <button class="btn ml-3 d-none" type="submit" id="submit-pap-type">Save</button>
                </dd>
            </dl>
        </form>
        ...
        <form action="{{ route('projects.update', $project) }}" accept-charset="UTF-8" method="post">
            ...
            <dl class="form-group d-inline-block my-0">
                ...
                <dd>
                    ...
                    <script>
                        // toggle visibility on change
                        document.getElementById('has_infra_0').addEventListener('click', function () {
                            console.log('0 is toggled')
                            if ({{ old('has_infra', $project->has_infra) }} !== 0) {
                                document.getElementById('submit-has-infra').classList.remove('d-none');
                            } else {
                                document.getElementById('submit-has-infra').classList.add('d-none');
                            }
                        });
                        document.getElementById('has_infra_1').addEventListener('click', function () {
                            console.log('1 is toggled')
                            if ({{ old('has_infra', $project->has_infra) }} !== 1) {
                                document.getElementById('submit-has-infra').classList.remove('d-none');
                            } else {
                                document.getElementById('submit-has-infra').classList.add('d-none');
                            }
                    ...
                    <button class="btn ml-3 d-none" type="submit" id="submit-has-infra">Save</button>
                </dd>
            </dl>
        </form>
        ...
        <form action="{{ route('projects.update', $project) }}" accept-charset="UTF-8" method="post">
            ...
            <dl class="form-group d-inline-block my-0">
                ...
                <dd>
                    ...
                    <script>
                        function compareCheckedBases() {
                            console.log('click is triggered');
                            const checked = document.querySelectorAll('.bases:checked'),
                                checkedValues = [],
                                oldValues = {{ $project->bases->pluck('id') }};
                            if (checked.length) {
                                checked.forEach(el => {
                                    // convert the value to number
                                    checkedValues.push(Number(el.value));
                                });
                            }
                            console.log(checkedValues)
                            console.log(oldValues)
                            if (_.isEqual(checkedValues, oldValues)) {
                                console.log('arrays are equal');
                                document.getElementById('submit-bases').classList.add('d-none');
                            } else {
                                console.log('arrays are not equal');
                                document.getElementById('submit-bases').classList.remove('d-none');
                            }
                        }
                    </script>

                    <button class="btn ml-3 d-none" type="submit" id="submit-bases">Save</button>
                </dd>
            </dl>
        </form>
                ...
                <dd class="form-group-body">
                    ...
                    @push('scripts')
                        <script>
                            ...
                            mdeDescription.value(`{{ $project->description->description }}`)
                        </script>
                    @endpush
